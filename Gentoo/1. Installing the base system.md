...
USE="-gtk -gnome dist-kernel dbus alsa wayland bluetooth elogind opengl nvenc cuda lua v4l screencast" # [!code ++]
...
For convenience install `tree` and `sudo` packages:

```sh
emerge --ask app-text/tree app-admin/sudo
```
