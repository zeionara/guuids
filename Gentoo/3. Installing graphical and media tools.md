...
To install `xdg-desktop-portal-hyprland`, enable the `guru` repository (if you've installed `keyd` from `guru` in the previous chapter, the repo should be enabled already):
