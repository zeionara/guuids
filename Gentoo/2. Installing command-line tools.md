...
For testing syntax highligting, move to the test project created earlier:
...
Copy `python lsp` server config in the `projects` folder of `neovim` settings:
...
Create a custom config file, for example:
