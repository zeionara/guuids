...
If you don't see wireless interface, and you are running an `arm`-based device with `usb` dongle for wifi, there may be problem with switching device mode. Try unplug and plug the dongle back. If it does help, then you would create a custom startup script like:
